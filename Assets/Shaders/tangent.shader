Shader "Unlit/tangent"
{
    Properties
    {
        ...
        _MaskHeight("_MaskHeight",Float) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float exp = pow(sinTH, _Pow) * (i.worldpos.y> _MaskHeight) * (1-m.x);
